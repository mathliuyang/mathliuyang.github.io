let journals = [
    ...
    },
    {
        ...
        "scopeCN": "《国际计算数学杂志》（IJCM）是数值分析与科学计算领域的国际领先期刊，服务于来自学术界与工业界的计算数学研究者。该刊发表具有高科学价值的原创论文，内容涵盖计算数学在科学与工程中的深度应用。期刊欢迎涉及创新计算策略分析与应用的研究，以及对前沿方法进行严谨探讨的论文。主要研究主题包括：偏微分方程数值解、非局部与分数阶模型计算、多尺度建模与计算策略、并行计算、数值最优化与控制、计算线性代数方法、成像算法与深度神经网络配置、随机过程与不确定性量化、计算金融、计算医学及流行病学、反问题与数据分析、科学机器学习与目标导向计算等。该刊重视方法创新与数学严谨性，不接受仅为现有算法简单变体的文章。",
        "researchAreas": "数学 - 应用数学",
        "tips": "《Science China Mathematics》是由中国科学院与国家自然科学基金委员会联合主办、Springer出版的高水平综合性数学期刊，JCR Q1、中科院1区，影响因子约1.4。四川大学评级为数学B类，是国内外学者公认的顶级华人数学期刊之一，学术声誉与质量极高。该刊选稿严格，强调原创性与理论深度，主要发表基础数学与应用数学领域的重大创新成果，对数理分析、代数几何、偏微分方程、动力系统、数值计算及应用理论等方向均有较强兴趣。对于基于深度学习的数学建模或偏微分方程求解研究，SCI China Math持谨慎态度，更关注理论数学价值与方法论创新，若研究能在PINN、Neural Operator等方法中提供数学收敛性证明、误差分析或理论推广，可获得审稿人认可，否则难以通过初审。期刊审稿周期约3–8周，效率较高但竞争极为激烈。建议投稿前确保论文具有显著的理论贡献和严密推导，摘要与结论应突出数学创新与普适性。适合具备系统理论成果或高质量算法分析的学者投稿，作为高端研究成果发表的重要选择。",
        "indexed": "SCIE",
        "warning": false
    },
    {
